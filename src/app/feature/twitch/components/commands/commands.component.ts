        ...
        table: {
          dataSource: [
            ...
            },
            {
              ...
              description: `Every 30 minutes, a random pokemon with a higher change of being shiny can appear. Make sure you have an available slot before trying to catch. You have 3 attempts to catch it using this command`,
            },
            {
